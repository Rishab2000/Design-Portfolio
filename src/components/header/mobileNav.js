...
const MobileNav = (props) => {
    ...
    return (
        ...
        <nav className={navClass + " transtion-opacity duration-300 ease-in flex flex-col gap-8 items-center absolute w-full text-center pt-96 text-2xl font-avenir-bold bg-background-color"}>
