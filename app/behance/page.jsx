        ...
        <div className="w-11/12 lg:w-11/12 xl:w-10/12 max-w-8xl h-full flex flex-col gap-16 pt-4 pb-32 mx-auto homepage-intro">
            ...
            <Layout>
                <div className="w-full flex flex-col items-center">
                    ...
                    <div className="bg-behance-blue w-screen py-6 mb-8">
                    ...
                    <ProjectSubDescContainer className="lg:w-10/12">
                        ...
                        <div className="flex flex-row flex-wrap gap-8 font-avenir-book text-xs lg:text-sm mt-6 lg:-mt-4 mb-12 lg:mb-24">
                            <div className="w-full lg:w-5/12 h-20 lg:h-32 flex bg-background-color filter justify-center items-center gap-12 py-5">
                                <Image
                                    removeWrapper
                                    radius="none"
